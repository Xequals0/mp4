    ...
    for row in range(height):
        ...
        for column in range(width):
            ...
            if (digit_data[row][column] == '#' or digit_data[row][column] == '+' or digit_data[row][column] == 1 or
                ...
                print "Features after append in column again: " + str(features)

            else:
                features[row].append(0)
                print "Features after append in column again else statement: " + str(features)
